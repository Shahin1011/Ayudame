...
class ProviderNewPasswordScreen extends StatefulWidget {
  ...
  @override
  State<ProviderNewPasswordScreen> createState() =>
      _ProviderNewPasswordScreenState();
}

class _ProviderNewPasswordScreenState extends State<ProviderNewPasswordScreen> {
  ...
  Future<void> _setNewPassword(String newPassword) async {
          ...
          child: Column(
            ...
            children: [
              ...
              CustomLoadingButton(
                ...
                isLoading: isLoading,
                onTap: () {
                  _setNewPassword(newPassController.text.trim());
                },
              ),
            ],
          ),

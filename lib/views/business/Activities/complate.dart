...
class complatedScreen extends StatefulWidget {
  ...
  const complatedScreen({super.key, this.bookingId});

  @override
  State<complatedScreen> createState() => _complatedScreenState();
}

class _complatedScreenState extends State<complatedScreen> {
  // ছবির হুবহু কালার কোড
  final Color primaryGreen = const Color(0xFF1D4D3F); // ডার্ক গ্রিন
  final Color greyButtonColor = const Color(0xFFC4C4C4); // ধূসর বাটন
  final Color noteBorderColor = const Color(0xFFD1E2DD); // হালকা সবুজ বর্ডার
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF1F4F3), // হালকা ব্যাকগ্রাউন্ড
      appBar: AppBar(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      booking.status?.capitalizeFirst ?? "Completed", 

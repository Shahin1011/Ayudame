...
class UserProviderSelectionScreen extends StatefulWidget {
  ...
  @override
  State<UserProviderSelectionScreen> createState() => _UserProviderSelectionScreenState();
}

class _UserProviderSelectionScreenState extends State<UserProviderSelectionScreen> {
  ...
  void _navigateToSelectedScreen() {
    switch (selectedType) {
      ...
      case 'Provider':
        ...
        break;
      case 'Business owner':
        Navigator.pushNamed(context, '/Businesshome');
        break;
      case 'Event manager':
        Navigator.pushNamed(context, '/homeevent');
        break;
    }
  }

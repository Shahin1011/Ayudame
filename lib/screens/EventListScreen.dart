      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: IconButton(
              icon: Icon(
                  Icons.notifications_outlined, color: Color(0xFF1C5941)),
              onPressed: () {},
            ),
          ),
        ],
      ...
      body: ListView(
        ...
        children: [
          _buildEventCard(
            ...
            guests: '200',
            price: '\$50.00',
            location: 'St Stadium Jouers Prein, San Francisco Florida, United States',
          ),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Note: You have an extra '=' symbol in your original code on this line
                  Row(
                    children: [
                      Container(
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/eventedit');
                          },
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: _buildNavItem(
                    Icons.event_outlined, 'Create Event', true),
              ),
